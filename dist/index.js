...
// src/frontend/components/ServiceGrid.tsx
var import_react = __toESM(require_react(), 1);

// src/frontend/components/ServiceCard.tsx
...
var ServiceCard = ({
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
    className: "bg-white my-5 p-5 rounded-lg shadow-sm",
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "text-lg font-bold text-primary-500 mb-2.5",
        children: host.name
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "mt-4",
        children: [
          Object.entries(host.ports).map(([port, name]) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
                ...
                children: [
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
                    className: "font-mono bg-gray-100 px-1.5 py-0.5 rounded text-xs",
                    children: port
                  }, undefined, false, undefined, this),
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
              ...
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
                className: getStatusClass(ip, port),
                children: getStatusText(ip, port)
              }, undefined, false, undefined, this)
            ]
          }, port, true, undefined, this)),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
...
var ServiceGrid = ({
  ...
  const [portStatuses, setPortStatuses] = import_react.useState({});
  ...
  const checkAllPorts = async () => {
    ...
    Object.entries(config.tailnet_hosts).forEach(([ip, host]) => {
      Object.keys(host.ports).forEach((port) => {
        const key = `${ip}:${port}`;
        promises.push(checkPort(ip, port).then((isReachable) => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
    ...
    children: Object.entries(config.tailnet_hosts).map(([ip, host]) => /* @__PURE__ */ jsx_dev_runtime2.jsxDEV(ServiceCard_default, {
      ip,
      host,
      portStatuses,
      onAddService,
      onEditService
    }, ip, false, undefined, this))
  }, undefined, false, undefined, this);
};
var ServiceGrid_default = ServiceGrid;

// src/frontend/components/ServiceModal.tsx
...
var ServiceModal = ({
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
    ...
    children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
      className: "bg-white p-5 rounded-lg w-96 max-w-[90%]",
      children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
              ...
              children: [
                ...
                editingService && /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("button", {
                  type: "button",
...
var ServiceModal_default = ServiceModal;

// src/frontend/components/App.tsx
var jsx_dev_runtime4 = __toESM(require_jsx_dev_runtime(), 1);
var App = () => {
  const [config, setConfig] = import_react3.useState({ tailnet_hosts: {} });
  const [isModalOpen, setIsModalOpen] = import_react3.useState(false);
  const [editingService, setEditingService] = import_react3.useState(null);
  const [modalPrefilledData, setModalPrefilledData] = import_react3.useState(null);
  ...
  const handleAddService = (ip, hostName) => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("div", {
    className: "font-apple-system max-w-4xl mx-auto p-5 bg-gray-100 min-h-screen",
    children: [
      /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("h1", {
        className: "text-center text-gray-800 mb-8 text-2xl font-semibold",
        children: "Tailnet Application Discovery"
      }, undefined, false, undefined, this),
      ...
      /* @__PURE__ */ jsx_dev_runtime4.jsxDEV(ServiceGrid_default, {
        config,
        onAddService: handleAddService,
        onEditService: handleEditService,
        onRefreshConfig: loadConfig
      }, undefined, false, undefined, this),
      isModalOpen && /* @__PURE__ */ jsx_dev_runtime4.jsxDEV(ServiceModal_default, {
        editingService,
